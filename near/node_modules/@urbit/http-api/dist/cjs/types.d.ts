 ...
 * ```
 */
export declare type GallAgent = string;
/**
...
export declare type PokeInterface<T> = PokeHandlers & Poke<T>;
...
export declare type OnceSubscriptionErr = 'quit' | 'nack' | 'timeout';
...
export declare class ResumableError extends Error {
}
